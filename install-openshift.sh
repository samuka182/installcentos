...
ansible-playbook -i inventory.ini openshift-ansible/playbooks/prerequisites.yml --private-key=~/.ssh/authorized_keys
ansible-playbook -i inventory.ini openshift-ansible/playbooks/deploy_cluster.yml --private-key=~/.ssh/authorized_keys
