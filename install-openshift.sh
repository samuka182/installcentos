...
ansible-playbook -i inventory.ini openshift-ansible/playbooks/prerequisites.yml --private-key=~/.ssh/id_rsa.pub
ansible-playbook -i inventory.ini openshift-ansible/playbooks/deploy_cluster.yml --private-key=~/.ssh/id_rsa.pub
